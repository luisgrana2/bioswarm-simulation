...
```
cd existing_repo
git remote add origin https://mrs.fel.cvut.cz/gitlab/granalui/pigeon_simulation.git
git branch -M master
...
- [ ] [Set up project integrations](https://mrs.fel.cvut.cz/gitlab/granalui/pigeon_simulation/-/settings/integrations)

...
# Optimal Parameters: Repulsion Radius=2.57, Repulsion Weight=2.32, Param A=13.15, Param B=8.24, Param C=0.25
if __name__ == "__main__":
    ...
    target_mode = 2
    print(f"\nStarting CMA-ES Optimization for DYNAMIC LEADER Mode...")
    ...
    print(f"\nOptimization Complete for DYNAMIC LEADER.")
